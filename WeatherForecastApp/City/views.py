...
def get_city_weather(request):
    try:
        if request.method == 'POST':
            ...
            url = 'http://api.openweathermap.org/data/2.5/weather?q={},{}&appid={}&units=metric'.format(city_name, country_name, API_KEY)
    ...
    return render(request, 'City/cityform.html', countries_list)
